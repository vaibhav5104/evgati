...
The following table lists the versions of EvGati currently supported with security updates:
...
> ℹ️ EvGati is currently in early development. Only the latest stable release (`1.0.x`) receives security patches.
...
- **GitHub Issue:** [Open a private issue using GitHub Security Advisories](https://github.com/vaibhav5104/evgati/security/advisories)
...
We appreciate your help in keeping EvGati and its users safe!
