      ...
      <footer className="bg-gray-900 shadow-md py-25 md:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-green-400 mb-4">EvGati</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/faq" className="text-sm text-gray-600 hover:text-gray-900">Refund Policy</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 flex justify-between items-center">
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} EvGati By Vaibhav Sharma.<br/> All rights reserved.
            </p>
            <div className="flex space-x-4">
              <a href="https://x.com/vaibhav5104" className="text-gray-400 hover:text-gray-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="white"  viewBox="0 0 16 16" id="Twitter-X--Streamline-Bootstrap">
              ...
              <a href="#" className="text-gray-400 hover:text-gray-600 no-decoration">
